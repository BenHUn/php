...
<div class="container">
<div class="row align-items-center">
<div class="col-lg-6 mb-5 mb-lg-0 hover-style3 textcenter
text-lg-start">
...
<div class="col-lg-6">
<div class="ps-lg-5">
<h2 class="mb-3"><?php echo "Welcome
...
<li><a href="#!"><i class="fab fa-linkedinin"></
i></a></li>
</ul>
</div>
<div class="col-sm-6 col-lg-2 mb-4 mb-sm-5 mb-lg-0">
<h3 class="h5 font-weight-500 mb-3 mb-lg-4 textwhite
normal">Services</h3>
<ul class="footer-list02">
<li><a href="#!" class="text-white-60 hover
white">Web Design</a></li>
<li><a href="#!" class="text-white-60 hoverwhite">
Development</a></li>
<li><a href="#!" class="text-white-60 hoverwhite">
WordPress</a></li>
<li><a href="#!" class="text-white-60 hoverwhite">
...
<h3 class="h5 font-weight-500 mb-3 mb-lg-4 textwhite
normal">Newsletter</h3>
<div class="mb-0">
<!-- start form here -->
<form class="quform"
action="quform/newsletter-two.php" method="post" enctype="multipart/formdata"
onclick="">
...
w-100 py-2" type="submit"><span>Subscribe</span></button>
</div>
<div class="quform-loadingwrap
text-center"><span class="quform-loading"></span></div>
</div>
<!-- End Submit button -->
</div>
</div>
